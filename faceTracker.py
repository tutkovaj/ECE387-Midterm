...
max_right_pos = False
max_left_pos = True
minPos = 4 # This is the most left position within non-breakage range for the servo
maxPos = 11 # This is the most right position within non-breakage range for the servo
rangeRight = 170 # This refers the the X range for the face detection
rangeLeft = 150  # Same as reangeRight.

# If it's moving too fast and not stopping on a face, mess with this variable. The higher the number
...
def servo_left():
	...
	time.sleep(.01) # Sleep because it reduces jitter
